    ...
    <aside className="w-64 bg-neutral-900/50 backdrop-blur-xl border-r border-white/5 flex flex-col">
      <div className="p-6 border-b border-white/5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-semibold text-white tracking-tight">MAISON SHOWROOM</h1>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-white/5">
        <p className="text-[12px] text-white/60 text-center tracking-wider">Desarrollo By NexusCode</p>
      </div>
    </aside>
  );
};
